...
[$\hat{g}\hat{g}* = g_R^2 + g_R \overrightharp{g}_V - \overrightharp{g}_V g_R + \overrightharp{g}_V \dot \overrightharp{g}_V - \overrightharp{g}_V \times \overrightharp{g}_V$]::

[$ = g_R^2 + |\overrightharp{g}_V|^2 = g_R^2 + g_V^2 = 1$]::
